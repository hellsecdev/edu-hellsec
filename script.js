...
const i18n = {
  ru: {
    ...
    'כניסה מבוקרת ל AI בלי רעש מיותר': 'Контролируемый вход в AI без лишнего шума',
    'תוצר מדיד לקבוצה אחת': 'Измеримый результат для одной группы',
    ...
    'המסגרת ברורה: לא מעתיקים עיוור, לא מפרסמים מידע רגיש, ולא מציגים תוצר שהתלמיד לא יודע להסביר.': 'Рамка простая: не копируем вслепую, не публикуем чувствительные данные и не показываем работу, которую ученик не может объяснить.',
    ...
    'מפתח ועובד עם מערכות תוכנה, AI, סייבר ואוטומציה. התוכנית מועברת כמו עבודה אמיתית: רעיון, קוד, בדיקה, תיקון, פרסום והסבר.': 'Разрабатывает и работает с ПО, AI, кибербезопасностью и автоматизацией. Программа ведётся как реальная работа: идея, код, проверка, исправление, публикация и объяснение.',
  ...
  en: {
    ...
    'כניסה מבוקרת ל AI בלי רעש מיותר': 'Controlled entry into AI without unnecessary noise',
    'תוצר מדיד לקבוצה אחת': 'Measurable outcome for one group',
    ...
    'המסגרת ברורה: לא מעתיקים עיוור, לא מפרסמים מידע רגיש, ולא מציגים תוצר שהתלמיד לא יודע להסביר.': 'The frame is clear: no blind copying, no sensitive data publication, and no work the student cannot explain.',
    ...
    'מפתח ועובד עם מערכות תוכנה, AI, סייבר ואוטומציה. התוכנית מועברת כמו עבודה אמיתית: רעיון, קוד, בדיקה, תיקון, פרסום והסבר.': 'Builds and works with software systems, AI, cybersecurity and automation. The program is delivered like real work: idea, code, testing, fixing, publishing and explanation.',
